...
class ChaoxingStudyApp(wx.Frame):
    def __init__(self, parent, title):
        ...
        sys.stdout = RedirectText(self.output_text, max_lines=1)  # Redirect standard output
    ...
    def load_accounts(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            self.load_courses()  # Load courses after selecting an account
        dlg.Destroy()
    ...
    def on_start_study(self, event):
        ...
        # Create a thread to perform time-consuming operations
